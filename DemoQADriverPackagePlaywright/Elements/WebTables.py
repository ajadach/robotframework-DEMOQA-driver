# -*- coding: utf-8 -*-
import lxml.html
from DemoQADriverPackagePlaywright.instances import BROWSER, screenshot_on_fail, BUILT_IN
from DemoQADriverPackagePlaywright.data.elements import MAIN_XPATH, WEB_TABLES
...
class WebTables():
    ...
    def read_all_parameters(self):
        ...
        inner_html = BROWSER.get_element_attribute(xpath_headers, "innerHTML")
        ...
        inner_html = BROWSER.get_element_attribute(xpath_data, "innerHTML")
        root = lxml.html.fromstring(inner_html)
        divs = root.xpath(".//div")
        output = {}
        index_row = 0
