# -*- coding: utf-8 -*-
import lxml.html
from DemoQADriverPackageSelenium.instances import SELENIUM, screenshot_on_fail, BUILT_IN
from DemoQADriverPackageSelenium.data.elements import MAIN_XPATH, WEB_TABLES
